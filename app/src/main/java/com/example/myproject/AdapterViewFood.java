...
public class AdapterViewFood extends RecyclerView.Adapter<AdapterViewFood.Holder> {
    ArrayList<Food> adapterIteamChaletLists;
    ...
    public AdapterViewFood(ArrayList<Food> adapterIteamChaletLists, Context context) {
    ...
    public void onBindViewHolder(@NonNull Holder holder, int position) {
        Food viewFood=adapterIteamChaletLists.get(position);
