...
public class Edit_Food extends AppCompatActivity {
    ...
    private StorageReference ImagesReferenc;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Reference = FirebaseDatabase.getInstance().getReference().child("BMI").child("Food").child(key);

        ImagesReferenc = FirebaseStorage.getInstance().getReference().child("Food Images");
        ...
        image_edit = findViewById(R.id.image_food_edit);
        btn_upload_photo_edit = findViewById(R.id.button_upload_photo_edit);
        btn_save_food_edit = findViewById(R.id.button_save_edit);
        ...
        Reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists()) {
                    ...
                    Picasso.get().load(viewFood.getImage()).into(image_edit);
    ...
    private void StoreFoodInformation()
    {
        ...
        file_Path = ImagesReferenc.child(ImageUri.getLastPathSegment()  + ".jpg");
        ...
        uploadTask.addOnFailureListener(new OnFailureListener() {
            ...
            public void onFailure(@NonNull Exception e)
            {
                ...
                Toast.makeText(Edit_Food.this, "Error: " + message, Toast.LENGTH_SHORT).show();
            }
        }).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
            @Override
            public void onSuccess(UploadTask.TaskSnapshot taskSnapshot)
            {
                Toast.makeText(Edit_Food.this, "Food Image uploaded Successfully...", Toast.LENGTH_SHORT).show();
                ...
                Task<Uri> urlTask = uploadTask.continueWithTask(new Continuation<UploadTask.TaskSnapshot, Task<Uri>>() {
                    ...
                    public void onComplete(@NonNull Task<Uri> task)
                    {
                        if (task.isSuccessful())
                        {
                            ...
                            Toast.makeText(Edit_Food.this, "got the Food image Url Successfully...", Toast.LENGTH_SHORT).show();
    ...
    private void SavefoodnfoToDatabase()
    {
        ...
        Reference.updateChildren(ChaletMap).addOnCompleteListener(new OnCompleteListener<Void>() {
            @Override
            public void onComplete(@NonNull Task<Void> task) {
                if (task.isSuccessful()) {
                    Toast.makeText(Edit_Food.this, "Done ", Toast.LENGTH_SHORT).show();
                }
            }
        });
